 ...
 */
typedef unsigned long(*ioopm_refmem_hash_function)(elem_t);

typedef struct hash_table ioopm_refmem_hash_table_t;

/// @brief Create a new hash table
/// @return A new empty hash table
ioopm_refmem_hash_table_t *ioopm_refmem_hash_table_create(ioopm_refmem_hash_function hash, ioopm_refmem_cmp_function compare);
...
bool ioopm_refmem_hash_table_all(ioopm_refmem_hash_table_t *ht, ioopm_refmem_predicate P, void *x); //TODO: skriv om för elem_t format på key och value
...
bool ioopm_refmem_hash_table_any(ioopm_refmem_hash_table_t *ht, ioopm_refmem_predicate P, void *x); //TODO: skriv om för elem_t format på key och value
...
void ioopm_refmem_hash_table_apply_to_all(ioopm_refmem_hash_table_t *ht, ioopm_refmem_apply_function P, void *x); //TODO: skriv om för elem_t blabla
