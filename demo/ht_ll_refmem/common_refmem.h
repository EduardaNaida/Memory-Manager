...
typedef bool (*ioopm_refmem_predicate)(elem_t key, elem_t value, void *extra);
typedef void (*ioopm_refmem_apply_function)(elem_t key, elem_t *value, void *extra);
typedef int(*ioopm_refmem_cmp_function)(elem_t a, elem_t b);
...
*/
bool evaluate_predicate(ioopm_refmem_predicate prop, elem_t key, elem_t value, void *extra, bool invert_condition);